...
// +kubebuilder:rbac:groups=pki.generic.platform-mesh.io,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pki.generic.platform-mesh.io,resources=certificates/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=pki.generic.platform-mesh.io,resources=certificates/finalizers,verbs=update
